<template>
  ...
  <!-- пропсы нкогда не переопределяются!! -->
</template>
...
<!--когда страниц больше 5 кол-во кнопок пагинации === 7 (страницы, prev и next)
если это не первые 2 и не последние 2, то текущая страница располагается по центру

< 3 4 [5] 6 7 >
< 6 7 8 9 [10] >

проверить, что текущая страница по центру(индекс в последовательности)
если страниц больше 5, то кнопок все равно остается 7(страницы, prev и next)
-->
